...
```{r}
ggplotly(ggplot(checkm) + aes(x=completeness,y=contamination,color=sample,label=`bin`) + geom_point() + scale_y_reverse() + labs(color="Sample") + scale_color_brewer(palette = sample_palette))
```
